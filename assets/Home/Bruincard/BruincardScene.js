        ...
        <SafeAreaView style={[styles.body, {justifyContent:'space-between'}]}>
            <ScrollView>
                <View>
                    <View style={{height:149}}>
                        ...
                        <View style={{paddingLeft: 20}}>
                            ...
                            <Text style={{fontSize: 12, color: "red", fontWeight: "900"}}>네트워크 오류(이모티콘)</Text>
                        </View>
                    </View>
                    ...
                    <View style={{paddingLeft:20, paddingRight:20}}>
                        <View>
                            ...
                            <View style={{flexDirection:'row', justifyContent: 'space-between', paddingTop: 30}}>
                                ...
                                <View style={{flexDirection:'row'}}>
                                    <TextInput style={[button_styles.text_input, {width:25}]} textAlign='center' />
                                    <View style={{width:15, alignItems:'center'}}>
                                        <Text style={{fontWeight:'900'}}>/</Text>
                                    </View>
                                    <TextInput style={[button_styles.text_input, {width:25}]} textAlign='center' />
                                    <View style={{width:60, alignItems:'center'}}>
                                        <Text style={{fontWeight:'900'}}>CVC</Text>
                                    </View>
                                    <TextInput style={[button_styles.text_input, {width:86}]} textAlign='center' />
                                </View>
                            </View>
                            <View style={{flexDirection:'row', justifyContent: 'space-between', paddingTop: 30}}>
                ...
                <View style={{justifyContent:'flex-end'}}>
                    <TouchableOpacity style={{alignItems:'center', paddingTop:49, paddingBottom:42}}>
